...
totals = read.delim("/Volumes/Beta/data/flow/randSeedTest/r25_42/all.totalCellCounts.metrics.txt", stringsAsFactors = FALSE)
freqs =read.delim("/Volumes/Beta/data/flow/randSeedTest/r25_42/all.freq.metrics.txt", stringsAsFactors = FALSE)
...
for(id in manifest$Lab.ID){
 ...
 write.table(
  manifest,
  file =
  "/Volumes/Beta/data/flow/HRS_sample_list_gated.txt",
  row.names = FALSE,
  quote = FALSE,
  sep = "\t"
  )
 ...
 write.table(
  totals,
  file =
  "/Volumes/Beta/data/flow/all.totalCellCounts.metrics.manifest_matched.txt",
  row.names = FALSE,
  quote = FALSE,
  sep = "\t"
  )
