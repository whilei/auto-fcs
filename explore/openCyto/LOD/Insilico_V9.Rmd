...
save(merge,file ="/Volumes/Beta/data/flow/LODCtrlsV8/merge.RData" )
```

```{r  include=FALSE}

load("/Volumes/Beta/data/flow/LODCtrlsV8/merge.RData")
#24HRS
#over
#_BC-D24-S+F_72HRS
#Ctl
...
for(panel in unique(mergeAll$PANEL) ){
  ...
  # print(pb)
  # pb=ggplot(sub,aes(x=Count,y=SAMPLE_CV,colour=MACHINE.x)) +
  # geom_point() +
