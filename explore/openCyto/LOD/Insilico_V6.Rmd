...
totals = read.delim("/Volumes/Beta/data/flow/LODCtrlsV6/all.totalCellCounts.metrics.txt", stringsAsFactors = FALSE)
freqs = read.delim("/Volumes/Beta/data/flow/LODCtrlsV6/all.freq.metrics.txt", stringsAsFactors = FALSE)
