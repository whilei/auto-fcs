...
totals = read.delim("/Volumes/Beta/data/flow/LODCtrls/all.totalCellCounts.metrics.txt", stringsAsFactors = FALSE)
freqs = read.delim("/Volumes/Beta/data/flow/LODCtrls/all.freq.metrics.txt", stringsAsFactors = FALSE)
