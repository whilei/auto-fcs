...
cvResultsSummaryScript=cvResultsSummary[which(cvResultsSummary$MANUSCRIPT_RANGE==TRUE),]


cvResultsSummaryScriptSummary= aggregate(REDUCTION ~ PANEL + MACHINE.x ,
      cvResultsSummaryScript,
      median,na.rm=TRUE
    )

write.table(
      cvResultsSummaryScriptSummary,
      file = "/Users/Kitty/git/auto-fcs/explore/openCyto/LOD/summary/lod.summary.manuscript.range.medianReduction.txt" ,
      sep = "\t",
      quote = FALSE,
      row.names = FALSE
    )
