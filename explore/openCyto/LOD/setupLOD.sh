...
for i in `seq 1 $batchIters`;do
	...
	echo "Rscript $outDir/SubSample_NonCtls_$i.R" >> $outDir/"InsilicoLOD_$i.qsub"
	cp /home/tsaim/lane0212/git/auto-fcs/explore/openCyto/LOD/SubSample_NonCtls.R $outDir/"SubSample_NonCtls_$i.R"
