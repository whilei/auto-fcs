...
combo=read.delim("/Users/Kitty/git/auto-fcs/explore/openCyto/extractManualComp/manualUse.100.txt",header = TRUE, stringsAsFactors = FALSE)
...
c("effector helper Tcells (CCR7- CD45RA+)","E.HT"),
c("effector memory helper Tcells (CCR7- CD45RA-)", "EM.HT"),
c("central memory helper Tcells (CCR7+ CD45RA-)","CM.HT"),

c("B cells (CD3- CD19+)", "Bcell"),
c("IgD+ memory Bcells (CD27+)", "IgD.MemB"),
c("IgD- memory Bcells (CD27+)", "IgD.MemB.1"),
c("naive Bcells (CD27- IgD+)", "N"),


c("DC NK MONOCYTES (CD3- CD19-)", "DC.NK.MONO"),
c("MONOCYTES (CD14+)" ,"MONO"),
c("Classical monocytes (CD16- CD14+)", "MONOc"),
c("Non classical monocytes (CD16+ CD14+)", "MONOnc"),
c("NK (CD16+)", "NK"),
c("NK CD56HI", "NKHI"),
c("NK CD56LO", "NKLO")
...
print(map)
merge = merge[which(merge[map[2]]<1000),]
