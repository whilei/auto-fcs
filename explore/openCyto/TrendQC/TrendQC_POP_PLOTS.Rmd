...
for (pop in unique(popsOfInterest$POPC)[1:3]) {
  ...
  test1 = cor.test(merge[, colC], merge[, coljflowCount], method = "pearson")
  print(test1)
  test2 = cor.test(merge[, colC], merge[, coljflowCount], method = "spearman")
  print(test2)
