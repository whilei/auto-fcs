...
# lymph=latestUse[which(latestUse$Manual=="Lymphocytes (SSC-A v FSC-A)"),]
# table(lymph$Count>10000)
# pbmc=latestUse[which(latestUse$Manual=="Live Single PBMCs (SSC-A/FSC-A)"),]
# table(pbmc$Count>10000)
