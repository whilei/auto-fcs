...
comboP2=combo[which(combo$TEMPLATE_FILE_USEDTRIM=="lymph.LSR.f"|combo$TEMPLATE_FILE_USEDTRIM=="lymph.FORTESSA.f"|combo$TEMPLATE_FILE_USEDTRIM=="dc.LSR.c"|combo$TEMPLATE_FILE_USEDTRIM=="dc.FORTESSA.c"),]
...
comboP2=comboP2[which(comboP2$RealAutoParent.x!="CD4"&comboP2$RealAutoParent.x!="CD8"&comboP2$RealAutoParent.x!="CD4"),]
comboP2=comboP2[which(comboP2$RealAutoParent.x!="CD8/CCR7-CD45RA-"&comboP2$RealAutoParent.x!="CD8/CCR7-CD45RA+"&comboP2$Parent.x!="CD4"),]


probs=comboP2$freqParent.x!=comboP2$freqParent.y
comboP2Probs=comboP2[probs,]
comboP2Probs=comboP2Probs[which((comboP2Probs$DIFF>0.02&comboP2Probs$Parent.x!="Bcells")|(comboP2Probs$Parent.x=="Bcells"&comboP2Probs$DIFF>0.03)),]

rm =!grepl("Ctl",comboP2Probs$name.x)
comboP2Probs=comboP2Probs[rm,]
rm =!grepl("Specimen",comboP2Probs$name.x)
comboP2Probs=comboP2Probs[rm,]
rm =!grepl("CTL",comboP2Probs$name.x)
comboP2Probs=comboP2Probs[rm,]
rm =!grepl("7DAYS",comboP2Probs$name.x)
comboP2Probs=comboP2Probs[rm,]
rm =!grepl("72HRS",comboP2Probs$name.x)
comboP2Probs=comboP2Probs[rm,]
rm =!grepl("24HRS",comboP2Probs$name.x)
comboP2Probs=comboP2Probs[rm,]
...
comboP1=comboP1[which(comboP1$DIFF>0),]
