...
rand = read.delim("/Volumes/Beta/data/flow/results_test_reviseTCells/all.freq.metrics.txt", stringsAsFactors = FALSE)
rand$KEY=paste0(rand$name,rand$Population,rand$Panel,rand$Parent,rand$MACHINE,rand$Manual)
use=!(rand$name %in% manual$V1)
rand=rand[use,]
reg= read.delim("/Volumes/Beta/data/flow/results_r25_24full_SS_SubCD8_SCD14_Manuals/all.freq.metrics.txt", stringsAsFactors = FALSE)
...
write.table(
  comboP2Probs,
  file =
  "/Users/Kitty/git/auto-fcs/explore/openCyto/Completions/toDoubleCheckOriginal.txt",
  row.names = FALSE,
  quote = FALSE,
  sep = "\t"
  )
