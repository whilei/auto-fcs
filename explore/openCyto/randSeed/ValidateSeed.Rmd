...
# t=combo[which(combo$freqParent.x!=combo$freqParent.y),]
t=combo[which(combo$Count.x!=combo$Count.y),]
t=combo[which(combo$freqParent.x-combo$freqParent.y>.01),]

use=!(t$name.x %in% manual$V1)
t=t[use,]
