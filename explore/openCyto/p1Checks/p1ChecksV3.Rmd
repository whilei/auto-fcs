...
counts=    read.xlsx(xlsxFile = "/Volumes/Beta/data/flow/p1CheckCounts/p1.second.data.xlsx",sheet = 1)
counts=counts[,c(1:55)]

write.table(counts[which(counts$`effector.helper.Tcells.(CCR7-.CD45RA+).(Comp-BV421-A.(CCR7).v.Comp-BV711-A.(CD45RA))`<1),]$Sample,file = "/Volumes/Beta/data/flow/p1CheckCounts/allCounts.potential.fails.txt")
...
latest=    read.xlsx(xlsxFile = "/Volumes/Beta/data/flow/p1CheckCounts/p1.second.data.xlsx",sheet = 1)
