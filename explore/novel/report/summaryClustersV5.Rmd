...
map=map[,c("FILE","TOTAL_COUNTS","PANEL","MACHINE","EXPERIMENTER")]
...
# tmp=unique(summary[,c("SAMPLE_RAW_SCALE_CENTROID","MACHINE")])
# table(tmp$MACHINE)
...
subHC = sub[, paste0(markersToCluster,"_RAW_SCALE_CENTROID")]
...
for(marker in markersToCluster){
  mraw = paste0(marker, "_RAW_SCALE_CENTROID")
...
cols["SAMPLE_RAW_SCALE_CENTROID","DESCRIPTION"]="Sample used for centroids (just a check)"
cols["SAMPLE_RAW_SCALE_CENTROID","DESCRIPTION"]="Sample used for centroids (just a check)"
...
# markers = colnames(summary)[grepl(pattern = "_SCALED_CENTROID",  colnames(summary))]
# markers = markers[!grepl(pattern = "SAMPLE", markers)]

subB =summary[, c("META_CLUSTER",markers),]
# 
# 
# 
