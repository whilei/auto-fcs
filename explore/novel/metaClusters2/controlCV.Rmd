...
summary$SAMPLE_META_COUNT=paste0(summary$SAMPLE,"_",summary$META_CLUSTER)
totCount=aggregate(summary$TOTAL_PHENOGRAPH_COUNTS, list(summary$SAMPLE_META_COUNT), sum)
...
# nlevels(summary$META_CLUSTER)
# summary$META_CLUSTER=as.factor(summary$META_CLUSTER)
# length(unique(summary$META_CLUSTER)
...
resultsMetaCVSummary=aggregate(resultsMetaCV$CV, list(resultsMetaCV$META_CLUSTER), median,na.rm=TRUE)
